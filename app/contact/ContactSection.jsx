...
export default function ContactContent() {
    return (
        <section className="w-full relative bg-[#0a0a0a] text-white py-16">
            <div  style={{ zIndex: 0 }} className="fixed inset-0 bg-gradient-to-b from-orange-500/40 via-transparent to-transparent blur-2xl" />
                        ...
                        <div className="flex items-center gap-4">
                            <a
                              target="_blank"  href="http://facebook.com/BullishPixel"
                                className="p-3 rounded-full border border-white/10 hover:bg-orange-500 transition"
                            >
